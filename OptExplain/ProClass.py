...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', '--model-path', default='/home/yifan/projects/Silas/Silas-GUI/silas-temp/results/model',
                        help='root of your Silas model')
    parser.add_argument('-t', '--test-file', default='/home/yifan/projects/Silas/Silas-GUI/test.csv',
                        help='path to your test file')
    parser.add_argument('-p', '--prediction-file', default='/home/yifan/projects/Silas/Silas-GUI/valid.csv',
