...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', '--model-path', default='OptExplain/optexplain-example/models',
                        help='root of your Silas model')
    parser.add_argument('-t', '--test-file', default='OptExplain/optexplain-example/test.csv',
                        help='path to your test file')
    parser.add_argument('-p', '--prediction-file', default='OptExplain/optexplain-example/pred.csv',
